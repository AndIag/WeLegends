var sumId = context.getVariable('urirequest.id'); //you should get this using context.getVariable()
var region = context.getVariable('urirequest.region');
var path = 'https://' + region + '.api.pvp.net/api/lol/' + region + '/v1.3/stats/by-summoner/' + sumId + '/ranked'; //new path
